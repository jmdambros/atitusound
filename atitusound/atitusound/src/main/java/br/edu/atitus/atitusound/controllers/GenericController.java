...
public abstract class GenericController <TEntidade extends GenericEntity,TDto> {
	...
	@GetMapping  
	public ResponseEntity<Page<List<TEntidade>>> get(@PageableDefault(page=0, size=10, sort="name",direction = Direction.ASC)org.springframework.data.domain.Pageable pageable, @RequestParam String name){
