...
public class ArtistController {
	...
	@GetMapping  
	public ResponseEntity<Page<List<ArtistEntity>>> get(@PageableDefault(page=0, size=10, sort="name",direction = Direction.ASC)org.springframework.data.domain.Pageable pageable, @RequestParam String name){
